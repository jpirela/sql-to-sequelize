// api/models/invoices.js
import { DataTypes } from 'sequelize';

export default (sequelize) => {
  const invoices = sequelize.define('invoices', {
 id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true, allowNull: false },
 serie: { type: DataTypes.STRING, allowNull: false, defaultValue: 'D13000' },
 ...
 discount_cupon: { type: DataTypes.DECIMAL, allowNull: false },
 ...
 order_platform: { type: DataTypes.STRING, allowNull: false },
