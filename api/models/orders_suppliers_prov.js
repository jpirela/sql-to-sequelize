// api/models/orders_suppliers_prov.js
import { DataTypes } from 'sequelize';

export default (sequelize) => {
  const ordersSuppliersProv = sequelize.define('ordersSuppliersProv', {
 ...
 pl_multitax_array: { type: DataTypes.STRING, allowNull: false },
    ...
    tableName: 'orders_suppliers_prov',
    timestamps: false,
  });

  ordersSuppliersProv.associate = (models) => {
    // Sin asociaciones
  };

  return ordersSuppliersProv;
};
